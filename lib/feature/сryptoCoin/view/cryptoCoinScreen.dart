...
// class CryptoCoinScreen extends StatefulWidget {
//   final CryptoCoin coin;
//   CryptoCoinScreen({super.key, required this.coin});
...
//                 ),
//                 SizedBox(height: 8), // Отступ между элементами
//                 Text(
//                   "Цена: \$${coin.priceInUSD?.toStringAsFixed(2) ?? 'N/A'}",
...
//                     onPressed: () {
//                       _cryptoBlock.add(
//                           LoadCryptoCoinEvent(currencyCode: widget.coin.name));
//                     },
